...
# Based on the Information Expert responsibility, a new functionality, e.g. 
# calculating the total price of a Sale, should be added to the class that has the
# most information about it, i.e. the Sale class.
@dataclass
class Sale:
