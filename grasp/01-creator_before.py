...
def main() -> None:
    ...
    # We create the SalieLineItem in the main function
    # Based on the Creator principle, we should create them in the Sale class,
    # because Sale closely controls the line items
