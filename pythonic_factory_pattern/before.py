...
#! Use protocol classes instead if abstract base class
#! To use protocols in a class you don't have to actually implement and
#! inherit is in order to use it -> the class definition becomes shorter
#! abstract base classes rely on nominal typing -> if you want types to relate
#! in some way, you have to explicitly write it down, like inherence
#! protocols rely on structural typings -> Python considers objects of matching types if
#! their structure is the same (e.g. objects have the same methods)
