...
class TradingBot(ABC):
    ...
    #! use the Bridge pattern to remove connect and get_market_data from here,
    #! because these are not really belongs to the Trading bot
    #! Create a separate hierarchies for both side of the bridge
    def connect(self):
