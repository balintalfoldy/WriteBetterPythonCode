...
#! This will give us the exporter factory based on user input
def read_factory() -> ExporterFactory:
    """Constructs an exporter factory based on the user's preference."""

    ˘#! This is the only place where we define the factories that are available
    factories = {
        "low": FastExporter(),
...
if __name__ == "__main__":
    # create the factory
    #! provide the factory to the main function as an argument -> gives more flexibility in how we can provide the factory to the main function (dependency injection!!!)
    factory = read_factory()

    # perform the exporting job
    main(factory)

#! read_factory() and main() has now much higher cohesion and also lower coupling,
#! because main no longer has to know anything about exporter code
#! Even read_exporter doesn't need to know that, it only needs to know the
