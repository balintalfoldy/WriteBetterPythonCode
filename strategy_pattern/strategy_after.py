...
#! abstract base class for the strategy interface
...
#! implementation of various ticket ordering strategies
...
class CustomerSupport:
    ...
    #! instead of getting a string, it recieves a ordering strategy object
